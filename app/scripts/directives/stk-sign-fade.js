...
/**
 * @ngdoc directive
 * @name stockWatchApp.directive:stkSignFade
 * @description
 * # stkSignFade
 */
  ...
  .directive('stkSignFade', function ($animate) {
      return {
          ...
          link: function ($scope, $element, $attrs) {
              var oldVal = null;
              //[1] use $observe to be notified onv alue changes
              $attrs.$observe('stkSignFade', function (newVal) {
                  ...
                  if (oldPrice && newPrice) {
                      ...
                      $animate.addClass($element, 'change-' + direction, function () { $animate.removeClass($element, 'change-' + direction); });
